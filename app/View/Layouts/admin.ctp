		...
		<div class="page-container container-fluid">
			...
			<div class="sidebar collapse">
				<ul class="navigation">
					...
					<li class="active">
						...
						<ul>
							<li>
								<?php
									echo $this->Html->link(
										'&raquo; ' . __('Words Manage'),
										ADMIN_ALIAS .  '/words-manage',
										$linkDefaults
									);
								?>
							</li>
							<li>
								<?php
									echo $this->Html->link(
										'&raquo; ' . __('Add new words'),
										ADMIN_ALIAS .  '/add-new-words',
										$linkDefaults
									);
								?>
							</li>
					...
					<li class="active">
						<a><i class="fa fa-th-large"></i> <?php echo __('Lessons'); ?></a>
						<ul>
							<li>
								<?php
									echo $this->Html->link(
										'&raquo; ' . __('Lessons Manage'),
										ADMIN_ALIAS .  '/lessons-manage',
										$linkDefaults
									);
								?>
							</li>
							<li>
								<?php
									echo $this->Html->link(
										'&raquo; ' . __('Add new lesson'),
										ADMIN_ALIAS .  '/add-new-lesson',
										$linkDefaults
									);
								?>
							</li>
